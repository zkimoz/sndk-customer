...
const T = {
  ar: {
    ...
    prof_plate:'رقم اللوحة', prof_plate_ph:'اختياري',
    prof_chassis:'رقم الشاصيه', prof_chassis_ph:'مثال: 1HGBH41JXMN109186',
  ...
  en: {
    ...
    prof_plate:'Plate Number', prof_plate_ph:'Optional',
    prof_chassis:'Chassis Number', prof_chassis_ph:'e.g. 1HGBH41JXMN109186',
...
function MyOrdersView({ lang, tr, isRtl, user, profile, onCountChange }) {
  ...
  const loadData = async () => {
    ...
    const { data: apptData } = await supabase.from('appointments')
      .select('*, cars(car_type, car_category, production_year, plate_number, chassis_number), job_cards(id, job_number, job_status, customer_complaints, work_done, mileage_in, mileage_out)')
